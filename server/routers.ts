    ...
    products: router({
      ...
      create: adminProcedure
        .input(z.object({
          ...
          category: z.enum(["beauty", "skincare", "electronics", "daily", "clothing", "shoes", "accessories"]),
      ...
      update: adminProcedure
        .input(z.object({
          ...
          category: z.enum(["beauty", "skincare", "electronics", "daily", "clothing", "shoes", "accessories"]).optional(),
